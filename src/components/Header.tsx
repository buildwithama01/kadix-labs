...
export function Header({
  badge = 'Venture Studio & Product Builder',
  title1 = 'Building Scalable Tech Products &',
  title2 = 'Future Companies',
}: {
  badge?: string;
  title1?: string;
  title2?: string;
  ...
  return (
    <div className="bg-background relative flex min-h-[90vh] w-full items-center justify-center overflow-hidden dark:bg-black pt-20">
      <div className="from-primary/20 dark:from-primary/30 absolute inset-0 bg-gradient-to-br via-transparent to-[#4ba4fd]/20 blur-3xl dark:to-[#4ba4fd]/30" />
      <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape
          ...
          height={60}
          rotate={20}
          gradient="from-cyan-500/40 dark:from-cyan-400/50"
        ...
        <ElegantShape
          ...
          height={40}
          rotate={-25}
          gradient="from-sky-500/40 dark:from-sky-400/50"
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <h1 className="mx-4 mb-6 text-4xl font-extrabold tracking-tight sm:text-6xl md:mb-8 md:text-7xl leading-[1.08]">
              ...
              <span
                className={cn(
                  'from-[#0b00da] to-[#4ba4fd] bg-gradient-to-r bg-clip-text pb-4 text-transparent',
                  'font-extrabold',
                )}
              >
                {title2}
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="text-muted-foreground mx-auto mb-10 max-w-2xl px-4 text-base leading-relaxed sm:text-lg md:text-xl">
          ...
          >
            <Button
              asChild
              size="lg"
              className="rounded-lg border-none bg-primary text-white shadow-md hover:bg-primary/90 transition-colors"
            >
              <Link to="/contact">
                Work With Us
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-primary/30 hover:bg-secondary/80 text-foreground font-semibold rounded-lg shadow-sm"
            >
              <Link to="/work">
                Explore Ventures
              </Link>
